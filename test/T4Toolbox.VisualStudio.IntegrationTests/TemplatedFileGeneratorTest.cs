...
namespace T4Toolbox.VisualStudio.IntegrationTests
{
    ...
    public class TemplatedFileGeneratorTest : IntegrationTest
    {
        ...
        public async Task GeneratorPassesInputFileNameToTemplateAsync()
        {
        ...
        [TestMethod, DataSource(TargetProject.Provider, TargetProject.Connection, TargetProject.Table, DataAccessMethod.Sequential)]
        public async Task GeneratorPassesInputFileContentToTemplateAsync()
        {
            await ThreadHelper.JoinableTaskFactory.SwitchToMainThreadAsync();
            Project project = this.CreateTestProject();
        ...
        [TestMethod, DataSource(TargetProject.Provider, TargetProject.Connection, TargetProject.Table, DataAccessMethod.Sequential)]
        public async Task GeneratorProducesMeaningfulErrorWhenTemplateIsNotSpecifiedAsync()
        {
            await ThreadHelper.JoinableTaskFactory.SwitchToMainThreadAsync();
        ...
        [TestMethod, DataSource(TargetProject.Provider, TargetProject.Connection, TargetProject.Table, DataAccessMethod.Sequential)]
        public async Task GeneratorProducesMeaningfulErrorWhenTemplateCannotBeFoundAsync()
        {
            await ThreadHelper.JoinableTaskFactory.SwitchToMainThreadAsync();
        ...
        [TestMethod, DataSource(TargetProject.Provider, TargetProject.Connection, TargetProject.Table, DataAccessMethod.Sequential)]
        public async Task GeneratorConvertsScriptFileToTemplateAsync()
        {
            await ThreadHelper.JoinableTaskFactory.SwitchToMainThreadAsync();
            ProjectItem inputItem = this.CreateTestProjectItem(TextFileItemTemplate);
